    ...
    <>
        <div className='bg-neutral-900 text-white overflow-x-auto h-screen'>
            <img className='m-5 h-12 absolute'src={emblem} alt = 'emblem'/>
                ...
                <div style={{boxShadow:'0 0 90px greenyellow'}} className='z-20 text-center pt-6 mt-20 h-76 flex flex-col justify-center bg-gradient-to-r from-stone-950 via-zinc-900 to-stone-950'>
